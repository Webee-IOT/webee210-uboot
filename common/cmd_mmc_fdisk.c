...
#define		SYSTEM_PART_SIZE		(256*1024*1024) //xjm change to 256M
//#define		SYSTEM_PART_SIZE		(120*1024*1024)
#define		USER_DATA_PART_SIZE		(1024*1024*1024)	/*(350*1024*1024)*/	
#define		CACHE_PART_SIZE			(4*_100MB)	//HJL, change from 100MB to 400MB as Dr.Zhou's suggestion
